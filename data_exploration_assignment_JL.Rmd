...
#p-value < 2.2e-16, z = 241.7, tau = 0.8053218 
cor.test(dt$Liver, dt$`Heart - Left Ventricle`, method = "kendall")
# Liver vs Brain answer
#z = 223.7, p-value < 2.2e-16 tau = 0.7342544 
cor.test(dt$Liver, dt$`Brain - Cortex`, method = "kendall")
# interpretation

# The Liver and Heart are more strongly correlated since it has a tau value of 0.8053218, which is a higher tau value than the comparison between the Liver and Brain-cortex (0.7342544) . This results make biological sense as both of these tissues play an important role in circulating blood and other physiological processes. For example, the Liver plays an important role in cleaning the blood. 
